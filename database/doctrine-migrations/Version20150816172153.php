 ...
 */
class Version20150816172153 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE migrations (migration VARCHAR(255) NOT NULL, batch INT NOT NULL, PRIMARY KEY(migration)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
